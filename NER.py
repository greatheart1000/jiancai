...
# 也可以根据sentence_id去重
print(data.head())
print(data.iloc[1].sentence )
print(data.iloc[1].word_labels)
#构建DataLoader
MAX_LEN = 91 # 120
TRAIN_BATCH_SIZE = 4
VALID_BATCH_SIZE = 2
...
比如：Washington的标签为 "b-gpe",分词之后得到， "Wash", "##ing",
 "##ton","b-gpe", "b-gpe", "b-gpe"""
...
# [] 避免报错TypeError: Found input variables without list of list.
